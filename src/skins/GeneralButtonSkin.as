package skins
{
	import assets.fxg.BlueRoundedRect;
	
	import spark.skins.mobile.ButtonSkin;
	
	public class GeneralButtonSkin extends ButtonSkin
	{
		private var colorized:Boolean = false;
		private const DISABLED_ALPHA:Number = 0.3
		
		public function GeneralButtonSkin()
		{
			super();
			upBorderSkin = BlueRoundedRect;
			downBorderSkin = BlueRoundedRect;
		}
